...
class TestConfig(unittest.TestCase):
    ...
    def test_get_json_config(self, mock_open, mock_load):
        # Arrange
        file_content = {'test-param': {'environment_variable': 'VALUE1', 'default': 'default'}}
    ...
    def test_load_app_config(self, mock_get_json_config):
        # Arrange
        self.app.config = {}
        mock_get_json_config.return_value = {'test-param': {'environment_variable': 'VALUE1', 'default': 'default'}}
